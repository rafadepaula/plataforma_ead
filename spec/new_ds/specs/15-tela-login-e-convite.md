...
**Kicker/título:** *Acesso / Entrar na plataforma*
**Views de origem:** `auth/login.blade.php`, `layouts/guest.blade.php`, `convite/show.blade.php`

## Objetivo
Login: painel de marca em --blue-100 (46%) + coluna 440px.

## Layout e componentes
Login: e-mail, senha, manter conectado, esqueci minha senha, CTA em bloco. Convite: nome, e-mail (aviso de vínculo a conta existente), CPF, consentimento em `Switch`, "Confirmar matrícula" ao lado do resumo do curso.

## Estados
Erro de validação: `.is-invalid` + mensagem em --critical abaixo do campo, nunca só a borda.
