# Testing Architecture (`resource/architecture.md`)
...
`tenancy-maintenance` (`resource/architecture.md`)), então toda feature test precisa fixar o host —
