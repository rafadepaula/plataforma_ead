...
- `tenancy-maintenance` (`resource/architecture.md`) — general org-scoped vs cascade-inherited rule
...
- `certificates-maintenance` (`resource/architecture.md`) — other module with pseudo-polymorphic
