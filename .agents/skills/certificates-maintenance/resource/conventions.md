...
- `public/certificates/lookup.blade.php` — the hash-less branch of the
  ...
  (the 100%-coverage rule; see `help-maintenance` (`resource/conventions.md`)). Any change to
...
- `public/certificates/show.blade.php` — **not** `layouts.app` (no
  ...
  — see `bootstrap-maintenance` (`resource/conventions.md`) §2), wrapped further in `.max-w-reading`
