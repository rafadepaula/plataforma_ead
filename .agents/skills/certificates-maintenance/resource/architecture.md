...
student at the issuing org's portal — see `notifications-maintenance` (`resource/conventions.md`).
...
`tenancy-maintenance` (`resource/architecture.md`) for the cascade-inherited-model rule.
