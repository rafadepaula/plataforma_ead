...
@section('content')
    <x-layout.page-header
        :breadcrumb="[['label' => 'Organização', 'url' => route('users.index')], ['label' => 'Alunos & Gestores', 'url' => route('users.index')], ['label' => 'Editar Usuário']]"
        kicker="Organização"
        title="Editar Usuário"
        subtitle="Atualize os dados, o papel e o status deste usuário."
    />
